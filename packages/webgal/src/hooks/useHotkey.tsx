...
// export type HotKeyComp = HotKeyEnum | `${HotKeyEnum}+${HotKeyEnum}` | `${HotKeyEnum}+${HotKeyEnum}+${HotKeyEnum}`;

// export type HotKeyConfig = HotKeyComp | HotKeyComp[];
