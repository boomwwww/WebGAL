...
const escapeConfigs: Array<EscapeConfig> = [
  {
    ...
    handler: (str: string, index: number,) => {
      ...
      return {
        value: '\a', rawValue: cut, next: index + 2,
      }
    }
  },
  {
    ...
    handler: (str: string, index: number,) => {
      ...
      return {
        value: '\b', rawValue: cut, next: index + 2,
      }
    }
  },
  {
  ...
  },
  {
    ...
    handler: (str: string, index: number,) => {
      ...
      return {
        value: '\t', rawValue: cut, next: index + 2,
      }
    }
  },
  {
    ...
    handler: (str: string, index: number,) => {
      ...
      return {
        value: String.fromCharCode(code), rawValue: cut, next: index + 6
      }
    }
  },
  {
    ...
    handler: (str: string, index: number,) => {
      ...
      if (cut !== '\\\r\n') throw new Error('Escape sequence must start with \\\r\n');
      return {
        value: '', rawValue: cut, next: index + 3,
      }
    }
  },
  {
